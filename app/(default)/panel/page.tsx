...
export const metadata = {
  title: "Panel Beton Berkualitas",
  description: "Katalog produk panel beton estetis dan kokoh dari Paving Beton Lestari Lampung.",
};
...
export default function page() {
  ...
  return (
    <section className="relative overflow-hidden bg-white pt-24 md:pt-32 pb-12 md:pb-24">
      ...
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-gradient-to-br from-blue-50/50 to-teal-50/30 rounded-full blur-3xl -translate-y-1/2 -translate-x-1/3 pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-gradient-to-tl from-slate-100/80 to-blue-50/40 rounded-full blur-3xl translate-y-1/3 translate-x-1/4 pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12 md:mb-20">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight" data-aos="fade-up" data-aos-delay="100">
            Panel Beton <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-teal-500">Berkualitas</span>
          </h1>
          <p className="text-lg md:text-xl text-slate-600 leading-relaxed mb-8" data-aos="fade-up" data-aos-delay="200">
            Perusahaan percetakan kami di Lampung menyediakan beragam produk konstruksi seperti pagar beton, panel beton, paving beton, dan fiberglass dengan kualitas terbaik.
            Panel beton kami dirancang dengan estetika tinggi dan kokoh untuk memenuhi kebutuhan desain proyek Anda.
          </p>
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-slate-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none flex items-end">
                <div className="p-6 w-full transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                  <h3 className="text-white font-bold text-lg mb-1">Panel Beton</h3>
