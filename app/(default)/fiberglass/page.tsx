...
export const metadata = {
  ...
  description: "Katalog produk fiberglass awet dan tahan cuaca dari Paving Beton Lestari Lampung.",
};
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-10 md:mb-16">
          ...
          <p className="text-base md:text-lg text-slate-600 leading-relaxed mb-8" data-aos="fade-up" data-aos-delay="200">
            Aneka olahan serat kaca tahan air dan cuaca. Awet dan kuat untuk perahu speedboat, bebek-bebekan air, kano, hingga kincir tambak.
          </p>
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-slate-900/20 to-transparent opacity-85 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none flex items-end">
                <div className="p-3 sm:p-5 w-full">
                  <h3 className="text-white font-bold text-xs sm:text-base leading-tight drop-shadow-md">{captions[index] || `Fiberglass #${index + 1}`}</h3>
