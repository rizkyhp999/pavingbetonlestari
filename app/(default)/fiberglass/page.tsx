...
export const metadata = {
  title: "Produk Fiberglass",
  description: "Katalog produk fiberglass inovatif dan tahan lama dari Paving Beton Lestari Lampung.",
};
      ...
      <div className="relative max-w-7xl mx-auto px-5 sm:px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12 md:mb-20">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight" data-aos="fade-up" data-aos-delay="100">
            Produk <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-teal-500">Fiberglass</span>
          </h1>
          <p className="text-lg md:text-xl text-slate-600 leading-relaxed mb-8" data-aos="fade-up" data-aos-delay="200">
            Perusahaan percetakan kami di Lampung menyediakan beragam produk konstruksi dan fiberglass dengan kualitas terbaik.
            Katalog fiberglass kami mencakup produk-produk inovatif dari material unggul yang dirancang untuk daya tahan luar biasa.
          </p>
        ...
        <div className="columns-1 sm:columns-2 lg:columns-3 xl:columns-4 gap-4 md:gap-6 space-y-4 md:space-y-6">
          {images.map((imageSrc, index) => (
            ...
            >
              <Image
                src={imageSrc}
                alt={captions[index] || `Fiberglass ${index + 1}`}
                fill
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-slate-900/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none flex items-end">
                <div className="p-6 w-full transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                  <h3 className="text-white font-bold text-lg mb-1">{captions[index]}</h3>
